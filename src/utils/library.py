...
def extract_functions(code: str) -> Set[str]:
    ...
    DSL_FUNCTIONS = {
            ...
            "adjacent",
            "apply_each_function",
            "apply_function_on_cartesian_product",
            "argmax",
            "argmin",
            "as_generic_tuple",
            "as_indices",
            ...
            "outbox",
            "paint_onto_grid",
            "paint_onto_grid_background",
            "pairwise",
            "palette",
            "partition",
            "partition_only_foreground",
            "position",
            "power",
            "recolor",
            "remove",
            "remove_duplicates",
            "remove_solid_color_strips_from_grid",
            "repeat",
            "replace",
            "right_half",
            "rightmost",
            ...
            "size",
            "size_filter",
            "smallest_subgrid_containing",
            "solid_color_strips_in_grid",
            "sort",
            "subtract",
            "switch",
            "to_horizontal_vec",
            ...
            "top_half",
            "transform",
            "transform_and_flatten",
            "transform_both",
            "transform_both_and_flatten",
            "trim_border",
            "union",
            "upper_left_corner",
            "upper_right_corner",
